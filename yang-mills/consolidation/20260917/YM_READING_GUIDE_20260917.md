...
The permanent identifier assigned to the prepared 17 September edition is [10.5281/zenodo.22803564](https://doi.org/10.5281/zenodo.22803564); its record becomes available when the archival upload is published. The GitHub collection contains the complete sources independently of that upload. Related [S6](https://doi.org/10.5281/zenodo.22678442) and [Navier–Stokes](https://doi.org/10.5281/zenodo.22678406) research has separate archival records. The manuscripts retain the relevant literature citations and attribution.
